<?php
/**
 * BTC Lightning Payment Gateways for WooCommerce - Input Fields Class
 *
 * @version 1.0.1
 * @since   1.0.0
 * @author  Reddatos
    ...
    if (class_exists('WC_Payment_Gateway')) {
        ...
        class WC_Coinos_Pay_Gateway extends WC_Payment_Gateway
        {
            ...
            public function __construct()
            {
                ...
                $this->icon = apply_filters('woocommerce_coinos_icon', plugins_url('/coinos-payments/assets/images/btc-ln-preferred.png'));
        		...
        		// todo: maybe make the button texts configurable via settings.
            ...
            public function init_form_fields() {
                $this->form_fields = apply_filters('woo_coinos_pay_fields', array(
                    ...
                    // 'tip_enabled' => array(
                    //     'title' => __('Tip Allowed', 'coinos-pay-woo'),
                    //     'type' => 'checkbox',
                    //     'label' => __('Enable or Disable Tip', 'coinos-pay-woo'),
                    //     'default' => 'no'
                    // ),
                    'title' => array(
