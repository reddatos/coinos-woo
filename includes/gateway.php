...
class WC_Gateway_CoinosWoo extends WC_Payment_Gateway
{
    ...
    if ( !function_exists( 'process_satoshi' ) ) {
    ...
    if ( !function_exists( 'process_invoice' ) ) {
    ...
    if ( !function_exists( 'request_payments' ) ) {
    ...
    if ( !function_exists( 'request_balance' ) ) {
    ...
    if ( !function_exists( 'thankyou_page_qrcode' ) ) {
    ...
    if ( !function_exists( 'thankyou_page_text' ) ) {
    ...
    if ( !function_exists( 'process_redirect' ) ) {
    ...
    if ( !function_exists( 'coinos_success' ) ) {
    ...
    if ( !function_exists( 'coinos_failure' ) ) {
